...
class MyDataset(Dataset):
    def __init__(self, file_path):
        '''
        :param file_path: the path of the npy file 
        containing the features and labels of data
        The data in the npy file is an array of shape (N, 3), 
        where the first two elements along the axis-1 are the features
        and the last element is the label of the data.
        '''
...
class Model(nn.Module):
    def __init__(self, input_size, output_size):
        ...
        1 for classification task of two class categories
        '''
...
def bce_loss(pred, label):
    ...
    ------------------------------
    :param pred: predictions with size [batch_size, *],
    * refers to the dimension of data
...
def train_val(train_file_path='data/character_classification/train_feat.npy',
    ...
    for epoch in range(n_epochs):
        ...
        # TODO: calculate average of the total loss for iterations and store it in losses
            ...
            avr_loss = total_loss / len(trainloader)
